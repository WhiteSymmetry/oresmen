...
* The oresmen version you are using.
...
Ready to contribute? Here's how to set up oresmen for local development.
...
2. Create your own fork of the oresmen [repository](https://github.com/WhiteSymmetry/oresmen).
...
Please note that the oresmen project is released with a
